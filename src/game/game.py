...
class Game:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption("Chemination")
        self.clock = pygame.time.Clock()
        self.font = pygame.font.Font("simhei.ttf", 20) if pygame.font.match_font("simhei.ttf") else pygame.font.Font(None, 20)
        self.big_font = pygame.font.Font("simhei.ttf", 36) if pygame.font.match_font("simhei.ttf") else pygame.font.Font(None, 36)
        self.block_font = pygame.font.Font("simhei.ttf", 28) if pygame.font.match_font("simhei.ttf") else pygame.font.Font(None, 28)
    ...
    def load_background_music(self):
        """加载背景音乐"""
        try:
            music_path = os.path.join("audio", "bgm.mp3")
                        ...
                        if event.key == pygame.K_m:
                            if self.music_loaded:
                                if self.music_playing:
                                    ...
                                    if self.music_loaded:
                                        self.unpause_background_music() if hasattr(self, 'music_loaded') and self.music_loaded else self.play_background_music()
